...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("flameshot gui"), { description = "Take a screenshot" })
-- hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("~/.config/hypr/scripts/screenshot.sh"), { description = "Take a screenshot" })
...
hl.bind(mainMod .. " + CTRL + SHIFT + S", hl.dsp.window.move({ workspace = "special:magic" }), { description = "Move window to special workspace magic" })
