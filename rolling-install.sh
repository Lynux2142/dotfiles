...
git clone --depth=1 --branch $TAG -c advice.detachedHead=false https://github.com/Lynux2142/ml4w-dotfiles-installer.git "$TEMP_DIR"
cd "$TEMP_DIR"
...
ml4w-dotfiles-installer --install https://raw.githubusercontent.com/Lynux2142/dotfiles/master/hyprland-dotfiles.dotinst
